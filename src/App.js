...
// _____________________________MD Saidul Basar Bappy___________________________
  return (
    <div className="App">
      <p className='head'>Welcome To Shaiadul Translate World !!</p>
      <div className=''>
        <span className='title'> From ({from}) :</span>
